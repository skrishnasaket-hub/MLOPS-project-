...
# Define paths
ARTIFACTS_PATH = "C:/Users/Admin/Desktop/mlops(115)/practical/mlops2025-DSC-main/Artifacts"
...
mlflow.set_experiment("XGBoost_Loan_Risk_Classification")

def training_pipeline(X_train, y_train):
    """
    Trains an XGBoost classifier and logs the model with MLflow.
    """
    try:
        ...
        with mlflow.start_run():
            ...
            log_info(f"Model trained and logged to MLflow at {MODEL_PATH}")
...
def evaluation_matrices(X_val, y_val):
    """
    Evaluates the model and logs metrics and artifacts with MLflow.
    """
    try:
